...
const IdleRegister = (props) => {
    ...
    function editEntry(item) {
        props.navigation.push('IdleEntry', { RegisterId: item.RegisterId });
    }
    function shareEntry(item) {
        props.navigation.push('IdleTemplate', { RegisterId: item.RegisterId });
    }
    return (
        <>
                ...
                <View>
                    <View style={switchValue == true ? '' : styles.hide}>
                        ...
                        <View style={[styles.row1, { width: '100%', }]}>
                            <Text style={[{ width: '100%', color: FONTCOLORS.primary, textAlign: 'left', fontWeight: 'bold', paddingLeft: 10, }]}>Type</Text>
                                ...
                                <View style={{ width: '100%', margin: 4 }}>
                                    ...
                                    <View style={{ width: '100%', marginTop: 5, }}>
                                        <View style={styles.pickerView}>
                                            <View style={{ borderWidth: 1, borderColor: FONTCOLORS.primary, width: "100%", height: 50, paddingBottom: 5, paddingTop: 15, paddingLeft: 10, }} >
                                                {
                                                    Platform.OS == 'android' ?
                            ...
                            <View style={{ width: '98%', paddingLeft: 5 }}>
                                <Text style={{ color: FONTCOLORS.primary, textAlign: 'left', fontWeight: 'bold', marginTop: 15 }}>Month</Text>

                                <TouchableOpacity onPress={() => showPicker(true)}>
                                    <Text style={[styles.textInput, { marginTop: show == false ? 20 : 100 }]} > {Moment(refDate).format('MMMM YYYY')}</Text>
                                </TouchableOpacity>
                                {show && (
                                    <MonthPicker
                                        style={{ color: FONTCOLORS.primary, textAlign: 'left', fontWeight: 'bold', paddingLeft: 5, marginTop: 15 }}

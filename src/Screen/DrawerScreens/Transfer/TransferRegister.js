...
import { Text, View, StyleSheet, FlatList, TouchableOpacity, Pressable, Platform, BackHandler, Switch, EventEmitter, ScrollView } from 'react-native';
...
const TransferRegister = (props) => {
    ...
    function editEntry(item) {
        if (entryType == 2) {
            props.navigation.push('TReceiptEntry', { RegisterId: item.RegisterId });
        } else {
            props.navigation.push('TDispatchEntry', { RegisterId: item.RegisterId });
        }
    }
    function shareEntry(item) {
        if (entryType == 2) {
            props.navigation.push('TReceiptTemplate', { RegisterId: item.RegisterId });
        } else {
            props.navigation.push('TransferTemplate', { RegisterId: item.RegisterId });
        }
    }
    return (
        <>
                ...
                <View>
                    <View style={switchValue == true ? '' : styles.hide}>
                        ...
                        <View style={[styles.row1, { width: '100%', }]}>
                            ...
                            <View style={[styles.Flatlistview1, { height: 50, }]}>
                                            ...
                                            return <View  ><TouchableOpacity style={styles.touch}>
                                                ...
                                                <View style={styles.Flatlistview} >
                                                    <View style={styles.col3}>
                                                        <Text style={styles.itemtittle} >From CostCentre Name</Text>
                                                    </View>
                                                    <Text style={styles.colon}>: </Text>
                                                    <View style={styles.col7}>
                                                        <Text style={styles.assetname} >
                                                            {item.FCostCentreName.slice(0, 15)}</Text>
                                                    </View>
                                                </View>
                                                <View style={styles.Flatlistview} >
                                                    <View style={styles.col3}>
                                                        <Text style={styles.itemtittle} >To CostCentre Name</Text>
                                                    </View>
                                                    <Text style={styles.colon}>: </Text>
                                                    <View style={styles.col7}>
                                                        <Text style={styles.assetname} >
                                                            {item.TCostCentreName.slice(0, 15)}</Text>
                                                    </View>
                                                </View>
                                                <View style={styles.Flatlistview} >
                                                    <View style={styles.col3}>
                                                        <Text style={styles.itemtittle} >Status</Text>
                                                    </View>
                                                    <Text style={styles.colon}>: </Text>
                                                    <View style={styles.col7}>
                                                        <Text style={styles.assetname} >
                                                        ...
                                                        <View style={redit == 0 ? styles.hide : ''}>
                                                            <TouchableOpacity onPress={() => editEntry(item)}>
                                                                <View style={{ flexDirection: 'row', paddingHorizontal: 4, paddingVertical: 5, borderRadius: 5, }}>
                                                                    <View>
                                                                        <Icon2 name="lead-pencil" type="ionicon" size={20} styles={{ color: FONTCOLORS.primary }} />
                                                                    </View>
                                                                </View>
                                                            </TouchableOpacity>
                                                        </View>
                                                    ...
                                                    <View style={styles.col10}>
                                                        <View style={rview == 0 ? styles.hide : ''}>
                                                            <TouchableOpacity onPress={() => shareEntry(item)}>
                                                                <View style={{ flexDirection: 'row', paddingHorizontal: 4, paddingVertical: 5, borderRadius: 5, }}>
                                                                    <View>
                                                                        <Icon2 name="eye" type="ionicon" size={20} styles={{ color: FONTCOLORS.primary }} />
                                                                    </View>
                                                                </View>
                                                            </TouchableOpacity>
                                                        </View>

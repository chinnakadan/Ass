    ...
    const retrieveData = async () => {
        try {
            ...
            if (RegisterId != 0) {
                ...
                if (RegData.IssueType == 'C') setIssueType('2');
                else setIssueType('1');
    ...
    const stepList = [{
        content: <View style={{ minwidth: '100%', height: '95%' }}>
            ...
            <View style={styles.row1.mtxttop}>
                <View style={{ width: '97%', marginLeft: '2.5%', marginRight: '0%', }}>
                    <View style={styles.pickerView}>
                        ...
                        <View style={{ borderWidth: 1, borderColor: COLORS.brdleftblue, height:50, paddingLeft:10, paddingTop:15}} pointerEvents={seldisabled}>
                            {
                                Platform.OS == 'android' ?
                                    <Picker
            ...
            <View style={issueType == 1 ? styles.mtxttop : styles.hide}>
                ...
                <View style={styles.centeredView} pointerEvents={seldisabled}>
                    <SPickList visible={empModalVisible} data={empData} onChange={empHandleChange} onChangeSearch={empSearch} search={onChangeSearchEmp} actionOnCancel={setEmpModalVisible} actionOnRow={actionOnRowEmp} />
                    <Pressable
                        style={[styles.button, styles.buttonOpen]}
            ...
            <View style={issueType == 2 ? styles.row1.mtxttop : styles.hide}>
                            ...
                            <View style={{ borderWidth: 1, borderColor: COLORS.brdleftblue, width: "100%" ,height:50, paddingLeft:10, paddingTop:15}} pointerEvents={seldisabled}>
                                {
                                    Platform.OS == 'android' ?
                                        ...
                                        <RNPickerSelect
                                            ...
                                            items={orderData.map((y) => {
                                                return { label: y.OrderNo.toString(), value: y.OrderId }; 
                                              })}
                                            onValueChange={(itemValue, itemIndex) => setOrderId(itemValue)}>

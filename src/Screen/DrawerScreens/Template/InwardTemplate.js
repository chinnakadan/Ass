...
const InwardTemplate = (props) => {
    ...
    function handleBackButtonClick() {
        props.navigation.navigate('InwardRegister');
        return true;
    }
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 ">
                <p class="companyName"> ${entryType} Entry</p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3 bg-success">
                ...
                <p style="padding: 0px 15px 0px 15px"> Vendor Name</p>
                <p style="padding: 0px 15px 0px 15px"> OrderNo</p>
    ...
    return (
        <ViewShot ref={viewShotRef} options={{ format: "jpg", quality: 0 }} style={{marginTop:30}}>
            <Loader loading={loading} />
            <View  ><TouchableOpacity style={styles.touch}>
                <View style={styles.Flatlistview} >
                    <View style={{ width: '70%' }}>
                        <Text style={styles.itemTitledate} >{entryType} Entry</Text>
                    </View>
                ...
                <View style={styles.Flatlistview} >
                    ...
                    <Text style={styles.colon}>: </Text>
                    <View style={styles.col7}>
                        <Text style={styles.assetname}>{vendorName}</Text>
                    </View>
                </View>
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                        <Text style={styles.itemtittle}>Order No</Text>
                    </View>
                    <Text style={styles.colon}>: </Text>
                    <View style={styles.col7}>
                        <Text style={styles.assetname}>{orderNo}</Text>
                    </View>
                </View>
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>

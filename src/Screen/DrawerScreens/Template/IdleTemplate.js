...
const IdleTemplate = (props) => {
    ...
    function handleBackButtonClick() {
        props.navigation.navigate('IdleRegister');
        return true;
    }
    ...
    const retrieveData = async () => {
        try {
            ...
            if (RegisterId != 0) {
                ...
                if (RegData.IdleType == 'R') setentryType('In Use');
                else setentryType('Idle');

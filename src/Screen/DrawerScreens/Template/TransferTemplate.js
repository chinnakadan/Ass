...
const TransferTemplate = (props) => {
    ...
    const [entryType, setentryType] = useState('Asset Transfer - Dispatch');
    ...
    const retrieveData = async () => {
        try {
            ...
            if (RegisterId != 0) {
                ...
                setDelivered(RegData.Delivered);
    ...
    function updatehtml() {
        ...
        transdata.map((userData) => {
            ...
            <td class="myAlign"></td>
            <td colspan='1'>${CommonFun.numberDigit(parseFloat(userData.Qty), 3)} ${userData.UnitName} </td>
     </tr>`;
        });
        settranshtml(shtml);
    }
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-3 bg-success">
                ...
                <p style="padding: 0px 15px 0px 15px"> Delivered</p>
    ...
    <tr>
        <table id="myTable">
            <tr class="header">
                <th colspan='7' style="width:80%;">
                <label class="border-center"> Asset Name</label>
                </th>
                <th class="myAlign"></th>
                <th colspan='1' style="width:20%;">Quantity</th>
            </tr>
            ${transhtml}
        </table >
    </div >
    ...
    return (
        <ViewShot ref={viewShotRef} options={{ format: "jpg", quality: 0 }}>
            ...
            <View  ><TouchableOpacity style={styles.touch}>
                ...
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                        <Text style={styles.itemtittle} >Delivered</Text>
                    </View>
                    <Text style={styles.colon}>: </Text>
                    <View style={styles.col7}>
                        <Text style={styles.assetname}>{delivered}</Text>
                    </View>
                </View>
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                                ...
                                renderItem={({ item, index }) => {
                                    return <View  ><TouchableOpacity >
                                        <View style={styles.Flatlistview}>
                                            ...
                                            <View style={styles.col3}>
                                                <Text style={styles.assetname}>{CommonFun.numberDigit(parseFloat(item.Qty), 3)} <Text style={styles.unit}>{item.UnitName}</Text></Text>
                                            </View>
                                        </View>
                                    </TouchableOpacity>
                                    </View>

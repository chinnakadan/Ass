...
const MakeTransferTemplate = (props) => {
    ...
    function updatehtml() {
        ...
        transdata.map((userData) => {
            shtml = shtml + `<tr>
            <td colspan='7'>${userData.ResourceName}</td>
            <td class="myAlign"></td>
...
export default MakeTransferTemplate;

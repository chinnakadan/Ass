...
import { FONTCOLORS ,COLORS} from "../../theme/theme";
const UsageTemplate = (props) => {
    const { RegisterId } = props.route.params;
    const viewShotRef = useRef(null);
    const [isSharingView, setSharingView] = useState(false);
    const [ClientId, setClientId] = useState('');
    const [UserId, setUserId] = useState('');
    const [entryType, setentryType] = useState('Usage Entry');
    ...
    const [startreading, setstartreading] = React.useState("");
    const [endReading, setendReading] = React.useState("");
    ...
    function handleBackButtonClick() {
        props.navigation.navigate('UsageRegister');
        return true;
    }
    ...
    const retrieveData = async () => {
        try {
            ...
            if (RegisterId != 0) {
                ...
                const usageTrans = datas.transList;

                setRefNo(RegData.RefNo);
                setRefdate(RegData.RefDate);
                setUsageType(RegData.UsageType);
                if (RegData.AssetType == 'H') setassetType('Hire');
                else setassetType('Own');
                ...
                if (usageTrans) {
                    setstartreading(usageTrans.StartReading);
                    setendReading(usageTrans.EndReading);
                    setstarttime(usageTrans.StartTime);
                    setendtime(usageTrans.EndTime);
                    settotaltime(usageTrans.TotalTime);
                    setoperatorName(usageTrans.OperatorName);
                    setfromlocation(usageTrans.FromLocaton);
                    settolocation(usageTrans.ToLocaton);
                }
                settransdata(datas.workdoneList);
            }
            setLoading(false);
        } catch (error) {
            setLoading(false);
    ...
    function updatehtml() {
        ...
        //         shtml = shtml + `<tr>
        //         <td colspan='7'>${userData.AssetName}</td>
        //         <td class="myAlign"></td>
        //         <td colspan='1'>${userData.Qty} ${userData.UnitName} </td>
        //  </tr>`;
        //     });
        settranshtml(shtml);
    }
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-3 bg-success">
                ...
                <p style="padding: 0px 15px 0px 15px"> Costcenter</p>
                <p style="padding: 0px 15px 0px 15px"> Asset Type</p>
                <p style="padding: 0px 15px 0px 15px"> Asset Name</p>
                <p style="padding: 0px 15px 0px 15px"> Qty</p>
          ...
          <div class="row">
        <div class="col-sm-3 bg-success">
            <p style="padding: 0px 15px 0px 15px"> Start Reading</p>
            <p style="padding: 0px 15px 0px 15px"> End Reading</p>
            <p style="padding: 0px 15px 0px 15px"> Start Time</p>
            <p style="padding: 0px 15px 0px 15px"> End Time</p>
            <p style="padding: 0px 15px 0px 15px"> Total Time</p>
            <p style="padding: 0px 15px 0px 15px"> From Location</p>
            <p style="padding: 0px 15px 0px 15px"> To Location</p>
    ...
    return (
        <ViewShot ref={viewShotRef} options={{ format: "jpg", quality: 0 }}>
            ...
            <View style={{marginTop:36,}} ><TouchableOpacity style={styles.touch}>
                ...
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                        <Text style={styles.itemtittle}>AssetType</Text>
                    </View>
                    <Text style={styles.colon}>: </Text>
                    <View style={styles.col7}>
                        <Text style={styles.assetname}>{assetType}</Text>
                    </View>
                </View>
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                ...
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                        <Text style={styles.itemtittle}>Qty</Text>
                    </View>
                    <Text style={styles.colon}>: </Text>
                    <View style={styles.col7}>
                        <Text style={styles.assetname}>{qty} {unitName}</Text>
                    </View>
                </View>
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                ...
                <View  ><TouchableOpacity style={styles.touch}>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            <Text style={styles.itemtittle} >Start Reading</Text>
                        </View>
                        <Text style={styles.colon}>: </Text>
                        <View style={styles.col7}>
                            <Text style={styles.assetname}>{startreading}</Text>
                        </View>
                    </View>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            <Text style={styles.itemtittle} >End Reading</Text>
                        </View>
                        <Text style={styles.colon}>: </Text>
                        <View style={styles.col7}>
                            <Text style={styles.assetname}>{endReading}</Text>
                        </View>
                    </View>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            <Text style={styles.itemtittle} >Start Time</Text>
                        </View>
                        <Text style={styles.colon}>: </Text>
                        <View style={styles.col7}>
                            <Text style={styles.assetname}>{starttime}</Text>
                        </View>
                    </View>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            <Text style={styles.itemtittle} >End Time</Text>
                        </View>
                        <Text style={styles.colon}>: </Text>
                        <View style={styles.col7}>
                            <Text style={styles.assetname}>{endtime}</Text>
                        </View>
                    </View>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            <Text style={styles.itemtittle} >Total Time</Text>
                        </View>
                        <Text style={styles.colon}>: </Text>
                        <View style={styles.col7}>
                            <Text style={styles.assetname}>{totaltime}</Text>
                        </View>
                    </View>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            <Text style={styles.itemtittle} >From Location</Text>
                        </View>
                        <Text style={styles.colon}>: </Text>
                        <View style={styles.col7}>
                            <Text style={styles.assetname}>{fromlocation}</Text>
                        </View>
                    </View>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            <Text style={styles.itemtittle} >To Location</Text>
                        </View>
                        <Text style={styles.colon}>: </Text>
                        <View style={styles.col7}>
                            <Text style={styles.assetname}>{tolocation}</Text>
                        </View>
                    </View>
                    <View style={styles.Flatlistview} >
                        <View style={styles.col3}>
                            ...
                            {/* <FlatList style={[styles.flatlist, { marginTop: 5 }]}
                                ...
                                renderItem={({ item, index }) => {
                                    return <View  ><TouchableOpacity style={styles.touch}>
                                        <View style={styles.Flatlistview}>
                                            <View style={styles.col7}>
                                                <Text style={styles.itemTitle2}> {item.AssetName}</Text>
                                            </View>
                                            <View style={styles.col3}>
                                                <Text style={styles.assetname}>{item.Qty} <Text style={styles.unit}>{item.UnitName}</Text></Text>
                                            </View>
                                        </View>
                                    </TouchableOpacity>
                                    </View>

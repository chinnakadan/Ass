...
const ReturnTemplate = (props) => {
    ...
    function handleBackButtonClick() {
        props.navigation.navigate('IssueRegister');
        return true;
    }
    ...
    const retrieveData = async () => {
        try {
            ...
            if (RegisterId != 0) {
                ...
                setIssueType(RegData.IssueType);
                setIssueTo(RegData.IssueTo);
    ...
    function updatehtml() {
        ...
        transdata.map((userData) => {
            shtml = shtml + `<tr>
            <td colspan='7' style="width:75%;">${userData.AssetName}</td>
            <td class="myAlign"></td>
            <td colspan='1'  style="width:15%;text-align:right;">${userData.IssueNo}</td>
            <td class="myAlign"></td>
            <td colspan='1'  style="width:15%;text-align:right;">${CommonFun.numberDigit(parseFloat(userData.Qty), 3)}</td>
            <td colspan='1'  style="width:10%;">${userData.UnitName} </td>
     </tr>`;
        });
        settranshtml(shtml);
    }
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 ">
                <p class="companyName"> Return Entry</p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3 bg-success">
                ...
                <p style="padding: 0px 15px 0px 15px"> Issue Type</p>
                <p style="padding: 0px 15px 0px 15px"> Issue To</p>
    ...
    <tr>
        <table id="myTable">
            <tr class="header">
                <th colspan='7' style="width:75%;">
                <label class="border-center"> Asset Name</label>
                </th>
                <th class="myAlign"></th>
                <th colspan='1' style="width:15%;"  >Issue No</th>
                <th class="myAlign"></th>
                <th colspan='1' style="width:15%;"  >Quantity</th>
                <th colspan='1' style="width:10%;"  >Unit</th>
            </tr>
            ${transhtml}
        </table >
    </div >
        ...
        <ViewShot ref={viewShotRef} options={{ format: "jpg", quality: 0 }}>
            ...
            <View  ><TouchableOpacity style={styles.touch}>
                <View style={styles.Flatlistview} >
                    <View style={{ width: '70%' }}>
                        <Text style={styles.itemTitledate} >Return Entry</Text>
                    </View>
                ...
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                        <Text style={styles.itemtittle}>Issue Type</Text>
                    </View>
                    <Text style={styles.colon}>: </Text>
                    <View style={styles.col7}>
                        <Text style={styles.assetname}>{issueType}</Text>
                    </View>
                </View>
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                        <Text style={styles.itemtittle}>Issue To</Text>
                    </View>
                    <Text style={styles.colon}>: </Text>
                    <View style={styles.col7}>
                        <Text style={styles.assetname}>{issueTo}</Text>
                    </View>
                </View>
                <View style={styles.Flatlistview} >
                    <View style={styles.col3}>
                    ...
                    <View style={{ marginBottom: 5, height: '81%' }}>
                        <View style={styles.Flatlistview}>
                            ...
                            <View style={styles.col20}>
                                <Text style={styles.itemTitle2}>IssueNo</Text>
                            </View>
                            <View style={styles.col20}>
                                <Text style={styles.itemTitle2}>Qty</Text>
                            </View>
                                ...
                                renderItem={({ item, index }) => {
                                    return <View  ><TouchableOpacity >
                                        <View style={[styles.Flatlistview, {}]}>
                                            ...
                                            <View style={styles.col20}>
                                                <Text style={styles.assetname}>{item.IssueNo}</Text>
                                            </View>
                                            <View style={styles.col20}>

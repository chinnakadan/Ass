...
const MakeTemplate = (props) => {
    ...
    const [entryType, setentryType] = useState('Production - Make');
    ...
    function handleBackButtonClick() {
        props.navigation.navigate('MakeRegister');
        return true;
    }
    ...
    function updatehtml() {
        ...
        transdata.map((userData) => {
            shtml = shtml + `<tr>
            <td colspan='7' style="width:75%;">${userData.ResourceName}</td>
            <td class="myAlign"></td>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-3 bg-success">
                ...
                <p style="padding: 0px 15px 0px 15px"> Plant CostCentre</p>
